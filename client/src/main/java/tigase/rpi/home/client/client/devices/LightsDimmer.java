 ...
 * @author andrzej
 */
public class LightsDimmer extends DeviceRemoteConfigAware<Integer, Light, tigase.rpi.home.client.devices.LightDimmer> {
		
	public LightsDimmer(tigase.rpi.home.client.devices.LightDimmer sensor) {
	...
	protected void showValues() {
		...
		for (int i=10; i>=0; i--) {
			...
			item.addClickHandler(new ClickHandler() {
				...
				public void onClick(ClickEvent event) {
					try {
						device.setValue(new Light(value, Light.Unit.procent), new tigase.rpi.home.client.Device.Callback<Light>() {
							@Override
