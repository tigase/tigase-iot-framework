...
import tigase.rpi.home.client.Device.Configuration;
import tigase.rpi.home.client.client.ClientFactory;
import tigase.rpi.home.client.client.ui.Form;

/**
 *
 * @author andrzej
 */
public abstract class DeviceRemoteConfigAware<S, T extends tigase.rpi.home.client.Device.IValue<S>, D extends tigase.rpi.home.client.Device<T>> extends DeviceRemoteAware<S, T>{
	...
	protected void showRenameWindow() {
		...
		button.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				dialog.hide();
				try {
					device.setName(name, new tigase.rpi.home.client.Device.Callback<String>() {
						@Override
	...
	protected void showConfigWindow() {
		try {
			device.retrieveConfiguration(new tigase.rpi.home.client.Device.Callback<Configuration>() {
				@Override
				public void onError(XMPPException.ErrorCondition error) {
			...
			button.addClickHandler(new ClickHandler() {
				...
				public void onClick(ClickEvent event) {
					try {
						...
						device.setConfiguration(config, new tigase.rpi.home.client.Device.Callback<Configuration>() {	
							public void onError(XMPPException.ErrorCondition error) {
